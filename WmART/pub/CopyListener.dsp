        ...
        <input type="hidden" name="passwordChange" value="false">
            ...
            <table width=100%>
                ...
                <tr>
                    <td  colspan=2>
                        <ul>
                            <li><a id="return_to_%value displayName%_listeners" href="ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&dspName=.LISTRESOURCES">
