            ...
            <tr>
                <td colspan=2>
                    <ul>
                        <li>
                        %ifvar readOnly equals('true')%
                            <a id="return_to_view_listener" href="ListenerDetails.dsp?readOnly=%value readOnly%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%&dspName=.LISTRESOURCES">
                                Return to View Listener
                            </a>
							<script>updateURL("return_to_view_listener", "Return to View Listener");</script>
                        %else%
                            <a id="return_to_edit_listener" href="ListenerDetails.dsp?readOnly=%value readOnly%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%&dspName=.LISTRESOURCES">
                                Return to Edit Listener
                            </a>
							<script>updateURL("return_to_edit_listener", "Return to Edit Listener");</script>
                        %endif%
                        </li>
                    </ul>
                </td>
