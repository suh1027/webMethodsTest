            ...
            <table width="100%">  
                ...
                <tr>
                    <td colspan=2>
                        <ul>
                            <li>
                                <a id="return_to_%value displayName%_listener_types" href="ListAdapterListenerTypes.dsp?adapterTypeName=%value -urlencode adapterTypeName%">
                                    Return to %value displayName% Listener Types
                                </a>
								<script>updateURL("return_to_%value displayName%_listener_types", "Return to %value displayName% Listener Types");</script>
                            </li>
                        </ul>
                    </td>
                </tr>
