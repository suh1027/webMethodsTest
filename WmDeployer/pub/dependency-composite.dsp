  ...
  %ifvar dependencies -notempty%
	...
	%loop dependencies%   
		...
		<img align=absmiddle hspace=0 border="0" src="images/tree_minus.gif" 
			style="cursor: hand;" id="tree_%value ../serverAliasName -urlencode%%value dependentCompositeDisplayName -urlencode%%value logicalServer -urlencode%" 
			...
			<img align=absmiddle border="0" src="images/composite.png" 
				align="absmiddle"> %value ../serverAliasName%:%value dependentCompositeDisplayName% %ifvar logicalServer -notempty% <b> ( %value logicalServer% )</b> %endif%  </td>
		...
		<script>writeTD("rowdata", "nowrap valign=\"top\"");</script></td>
  	     ...
  	     %loop dependentComponents%	  
				...
				<tr id="resource_%value ../../serverAliasName -urlencode%%value ../dependentCompositeDisplayName -urlencode%%value ../logicalServer -urlencode%%value dependentComponentDisplayName -urlencode%">
...
%loop dependencies1%
  ...
  %ifvar conflictDependencies -notempty%
	...
	%loop conflictDependencies%   
		...
		<img align=absmiddle border="0" src="images/blank.gif" width="0" height="15">
		<img align=absmiddle hspace=0 border="0" src="images/tree_minus.gif" 
			style="cursor: hand;" id="tree_%value ../serverAliasName -urlencode%%value dependentCompositeDisplayName -urlencode%_%value ../../conflictSuffix -urlencode%%value logicalServer -urlencode%" 
			onclick="toggleComposite('%value ../serverAliasName -urlencode%%value dependentCompositeName -urlencode%%value logicalServer -urlencode%');" width="9" height="9">
