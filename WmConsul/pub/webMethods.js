...
function createFormWithTatgetAndSetProperties(formname, action, method, parent_tag, target) {
...
function createFormAndSetProperties(formname, action, method, parent_tag) {
	createFormWithTatgetAndSetProperties(formname, action, method, parent_tag, null);
}
