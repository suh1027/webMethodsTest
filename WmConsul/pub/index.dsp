<html>
<head>
  <TITLE>webMethods MicroService Registry: %value $host% - webMethods Integration Server</TITLE>
...
<body>
  ...
  <div class="bottom">
    ...
    <iframe class="contentframe" name="body" id="body" src="settings-registry.dsp"></iframe>
  </div>
</body>
</html>
